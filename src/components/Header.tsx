...
export const Header = React.memo(function Header() {
  ...
  const toolbarActions = useMemo<{ icon: LucideIcon; title: string; onClick: () => void; className?: string }[]>(() => [
    ...
    { icon: darkMode ? Sun : Moon, title: darkMode ? '切换浅色模式' : '切换深色模式', onClick: handleToggleDarkMode, className: darkMode ? 'theme-toggle' : undefined },
    { icon: alwaysOnTop ? Pin : PinOff, title: alwaysOnTop ? '取消置顶' : '窗口置顶', onClick: handleToggleAlwaysOnTop, className: alwaysOnTop ? 'pin-active' : undefined },
